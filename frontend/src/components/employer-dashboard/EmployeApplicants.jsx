...
const EmployeApplicants = () => {
    ...
    const messages = [
        ...
        { id: 6, text: 'Good to hear!', sender: 'other' },
    ];
    ...
    return (
        <>
            ...
            <section className="absolute right-1 bottom-0 bg-[#fcfcfc] flex flex-col w-full md:w-[500px] rounded-t-md">
                ...
                <div className="max-h-[400px] overflow-y-auto hide-scrollbar space-y-1 px-2">
                ...
                {/* Input Area */}
                <div className='p-2'>
                    <div className='bg-white rounded-md p-2 flex items-center justify-between w-full border mt-4 focus-within:border-indigo-500'>
                        <input
                            type="text"
