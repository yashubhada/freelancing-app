...
const EmployeProfile = () => {
    ...
    useEffect(() => {
        if (EmployerProfileInfo) {
            ...
            setLoadingProfile(false); // Stop loading once profile data is set
        }
    }, [EmployerProfileInfo]);

    // Initial state setup based on fetched profile data
    const initialState = {
        name: "",
        email: "",
        profileImage: "",
    ...
    // Reducer function for handling profile updates
    ...
    const handleSaveProfile = async (e) => {
        ...
        try {
            ...
            fetchEmployerInfo(userId); // Refetch updated profile
