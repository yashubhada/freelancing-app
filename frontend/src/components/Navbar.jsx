...
const Navbar = () => {
    ...
    const toggleNav = () => {
        document.querySelector(".nav-items").classList.toggle('top-[82px]');
    }
            ...
            <nav className="bg-white border">
                <div className="px-2 py-2 md:px-0 container mx-auto flex items-center justify-between">
                    <div className="flex items-center justify-center">
                        ...
                        <ul className="absolute right-0 space-y-2 md:space-y-0 top-32 w-full p-2 bg-[#493932] md:bg-white text-white md:text-[#493932] md:p-0 md:static md:flex items-center justify-center md:ml-10 md:space-x-5 nav-items">
